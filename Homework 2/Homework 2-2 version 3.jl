...
p = 1 # max camber position (multiply by 10 to get percentage)
...
for i = 1:numPanels # i = row number
    ...
    for j = 1:numPanels
        if i == 1 || i == numPanels
            ...
            b[numPanels + 1] = -2*pi*freestream*cos(theta_controlPanel - alpha*pi/180)
...
for i = 1:numPanels
    ...
    theta_controlPanel = asin(panelSine) # Good
